...
public class Assets {
   ...
   */
  public static void drawCoin(float x, float y, float Scale, PGraphics render) {
    render.fill(0xFFFCC703);
   ...
   */
  public static void drawWorldSymbol(float x, float y, PGraphics render) {
    render.strokeWeight(0);
    render.fill(0xFF05F5F3);
    render.stroke(0xFF05F5F3);
    render.rect(x, y, 40, 20);
    render.fill(0xFF00F73B);
    render.stroke(0xFF00F73B);
    render.rect(x, y+20, 40, 20);
    render.rect(x, y+10, 10, 10);
    render.fill(0xFF8E6600);
    render.stroke(0xFF8E6600);
    render.rect(x+25, y+10, 5, 10);
    render.fill(0xFF008E08);
    render.stroke(0xFF008E08);
   ...
   */
  public static void drawPortal(float x, float y, float scale, PGraphics render) {
    render.fill(0);
    render.ellipse(x, y, 50*scale, 100*scale);
    render.fill(0xFFAE00FA);
   ...
   */
  public static void draw3DSwitch1(float x, float y, float Scale, PGraphics render) {
    render.fill(196);
    render.rect((x-20*Scale), (y-5*Scale), 40*Scale, 5*Scale);
    render.fill(0xFFFAB800);
  ...
  /**Draw the 3D version of the 3D on switch on the given renderer
   ...
   @param render The place to draw the switch to
   */
  public static void draw3DSwitch1(float x, float y, float z, float Scale, PGraphics render) {
    render.fill(196);
    //strokeWeight(0);
    render.translate(x, y-2.5f, z);
    render.box(40, 5, 40);
    render.fill(0xFFFAB800);
  ...
  /**Draw the 2D version of the 3D off switch on the given renderer
   ...
   @param render The place to draw the switch to
   */
  public static void draw3DSwitch2(float x, float y, float Scale, PGraphics render) {
    render.fill(196);
    render.rect((x-20)*Scale, (y-5)*Scale, 40*Scale, 5*Scale);
  }
  /**Draw the 3D version of the 3D off switch on the given renderer
   ...
   @param render The place to draw the switch to
   */
  public static void draw3DSwitch2(float x, float y, float z, float Scale, PGraphics render) {
    render.fill(196);
    //strokeWeight(0);
    render.translate(x, y-2.5f, z);
    render.box(40, 5, 40);
    render.fill(0xFFFF03D1);
    render.translate(0, -5, 0);
    render.box(20, 5, 20);
    render.translate(-x, -(y-7.5f), -z);
  }
   ...
   */
  public static void drawCheckPoint(float x, float y, float scale, PGraphics render) {
    render.fill(0xFFB9B9B9);
    render.rect((x-3)*scale, (y-60)*scale, 5*scale, 60*scale);
    render.fill(0xFFEA0202);
  ...
  /**Draw the 3D version of the sign
   ...
   @param render The place to draw the sign to
   */
  public static void drawSign(float x, float y, float z, float Scale, PGraphics render) {
   ...
   */
  public static void drawSpeakericon(float x, float y, float scale, PGraphics render) {
    render.fill(0xFF767676);
    render.strokeWeight(0);
   ...
   */
  public static void drawSoundBox(float x, float y, float scale, PGraphics render,boolean inLevelCreator) {
    if (inLevelCreator) {
      render.fill(0xFFF2C007, 127);
   ...
   */
  public static void drawLogicButton(float x, float y, float Scale, boolean pressed, PGraphics render) {
    render.fill(196);
    render.rect((x-20*Scale), (y-5*Scale), 40*Scale, 5*Scale);
    if (!pressed) {
      render.fill(0xFFFC2121);
      render.rect((x-10*Scale), (y-10*Scale), 20*Scale, 5*Scale);
    }
  }
  /**Draw the 4D version of the logic button
   ...
   @param render The place to draw the button to
   */
  public static void drawLogicButton(float x, float y, float z, float Scale, boolean pressed, PGraphics render) {
    render.fill(196);
    // strokeWeight(0);
    render.translate(x, y-2.5f, z);
    render.box(40, 5, 40);
  ...
  /**Draw the 3D stage icon
   ...
   @param render the place to draw the icon to
   */
  public static void draw3DStageIcon(float x, float y, float scale, PGraphics render) {
    render.directionalLight(255, 255, 255, 0.8f, 1, -0.35f);//setr up the lighting
    render.ambientLight(102, 102, 102);
    render.noStroke();
    render.translate(x, y, 0);
    render.rotateX(-PApplet.radians(30));
    render.rotateY(PApplet.radians(75));
    render.rotateZ(PApplet.radians(24));
  ...
  /**Draw the floppy disk save icon
   ...
   @param render The place to draw the icon to
   */
  public static void saveIcon(float x, float y, float scale, PGraphics render) {
    //floppy background color
    render.fill(0xFF4E74FA);
    ...
    render.fill(0xFFC4C4C4);//disk protector
